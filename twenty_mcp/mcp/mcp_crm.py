...
def register_crm_tools(mcp: FastMCP):
    ...
    async def twenty_mcp_crm(
        action: str = Field(description="Action to perform. Must be one of: 'get_people', 'create_person', 'get_companies', 'create_company', 'get_opportunities', 'create_opportunity', 'execute_gql'"),
