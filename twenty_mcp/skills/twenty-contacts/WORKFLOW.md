...
```json
{"object_name": "people", "filter": "emails.primaryEmail[eq]:[REDACTED_EMAIL]", "limit": 5}
```
Create a contact:
```json
{"first_name": "Jane", "last_name": "Doe", "email": "[REDACTED_EMAIL]", "jobTitle": "VP Sales"}
```
Create a company:
```json
