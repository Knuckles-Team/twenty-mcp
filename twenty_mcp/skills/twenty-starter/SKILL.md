...
name: twenty-starter
description: >-
  Twenty API + MCP Server + A2A Server Use when working with Twenty via this package's MCP
...
license: MIT
tags: [twenty-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Twenty Starter Skill

Starter skill for the **Twenty** package. Use the `mcp-client` universal skill
