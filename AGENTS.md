...
<!-- CONCEPT:TW-OS.governance.twenty-2 -->
<!-- CONCEPT:TW-OS.identity.twenty -->
...
|------------|------|-------------|
| `CONCEPT:TW-OS.governance.twenty` | Core API Client Operations | Dynamic API facade client integration |
| `CONCEPT:TW-OS.governance.twenty-2` | FastMCP Tools Execution | FastMCP tool registration and stdio handling |
| `CONCEPT:TW-OS.identity.twenty` | Identity & Gateway Security | Credential validation and SSL verification |
